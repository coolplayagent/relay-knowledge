...
- 除默认 fast profile 已覆盖的 C/C++、cross-language 和 TypeScript fixture 外，其他生成式 fixture 默认不加入普通 fast repository 列表；需要定向验证时设置 `RELAY_KNOWLEDGE_SELF_ITERATION_FAST_REPOS`，例如：
