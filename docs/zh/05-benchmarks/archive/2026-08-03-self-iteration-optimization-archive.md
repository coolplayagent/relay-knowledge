...
本文件保存[主记录](../04-self-iteration-accepted-optimizations.md)在 2026-08-03 为满足 tracked documentation 1000 行硬上限而迁出的历史段落。原始 patch、报告和渐进式记忆仍保留在 `.git/relay-knowledge-self-iteration/`。
