...
本归档保存[主记录](../04-self-iteration-accepted-optimizations.md)中 20260524-20260526 的后期详细条目，避免主记录文件超过 1000 行。主文件继续保留候选算法说明和摘要；完整 patch、报告和渐进式 memory 仍保留在 `.git/relay-knowledge-self-iteration/`。
