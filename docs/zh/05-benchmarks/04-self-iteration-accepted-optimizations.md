...
- patch: `/opt/workspace/relay-knowledge-refactor/.git/relay-knowledge-self-iteration/patches-v2/run-1779602603.patch`
- score: 0.970528 (foundational=1.000000, competitive=0.988636, accuracy=0.994318, semantic_vector=1.000000, research_judge=n/a, performance=0.850156, stability=1.000000)
- cases: 51/51 passed
- changed paths: `docs/zh/05-benchmarks/04-self-iteration-accepted-optimizations.md`, `src/relay_knowledge/application/code_query_source_fallback.rs`, `src/relay_knowledge/application/code_query_source_fallback_tests.rs`, `src/relay_knowledge/application/code_service.rs`, `src/relay_knowledge/code/identity/typescript.rs`, `src/relay_knowledge/code/parser/imports.rs`, `src/relay_knowledge/code/parser/manual.rs`, `src/relay_knowledge/code/parser_import_resolution_tests.rs`, `src/relay_knowledge/code/parser_tests.rs`, `src/relay_knowledge/domain/code_repository.rs`, `src/relay_knowledge/domain/mod.rs`, `src/relay_knowledge/storage/sqlite/code_batch/finalize_typescript_imports.rs`, `src/relay_knowledge/storage/sqlite/code_batch_finalize_typescript_tests.rs`, `src/relay_knowledge/storage/sqlite/code_query.rs`, `src/relay_knowledge/storage/sqlite/code_query_import_scoring.rs`, `src/relay_knowledge/storage/sqlite/code_query_path_ranking.rs`, `src/relay_knowledge/storage/sqlite/code_query_symbol_ranking_tests.rs`, `src/relay_knowledge/storage/sqlite/code_query_symbols.rs`
- key improvements: score_component:score 0.18->0.9705281691504489; score_component:foundational_capability 0.0->1.0; score_component:competitive_capability 0.0->0.9886363636363636; score_component:semantic_vector 0.0->1.0; score_component:stability 0.0->1.0
- known degradations: score_component:performance 1.0->0.8501564952802716
- latency metrics: cargo_fmt_check_ms=1536ms; self_iteration_cargo_fmt_check_ms=283ms; cargo_build_debug_ms=263ms; self_iteration_cargo_check_ms=101ms; temporal_samples_go_index_ms=121ms; temporal_samples_go_register_index_ms=186ms; temporal_sdk_go_index_ms=604ms; temporal_sdk_go_register_index_ms=665ms
