...
- patch: `/opt/workspace/relay-knowledge-refactor/.git/relay-knowledge-self-iteration/patches-v2/run-1779596855.patch`
- score: 0.954442 (foundational=1.000000, competitive=0.909091, accuracy=0.954545, semantic_vector=1.000000, research_judge=n/a, performance=0.858012, stability=1.000000)
- cases: 48/51 passed
...
- key improvements: score_component:score 0.940592->0.9544422173051637; score_component:performance 0.781066->0.85801231836202; metric:cargo_fmt_check_ms 2196.0->1934.0; metric:cargo_build_debug_ms 323.0->262.0; metric:temporal_sdk_go_index_ms 967.0->785.0; metric:temporal_sdk_go_register_index_ms 1028.0->846.0; metric:temporal_samples_go_index_ms 182.0->141.0; metric:c_syntax_fixture_register_index_ms 304.0->241.0
- known degradations: metric:leveldb_cpp_index_ms 202.0->351.0; metric:leveldb_cpp_register_index_ms 263.0->391.0; metric:leveldb_cpp_query_p95_ms 222.0->266.0; metric:cpp_syntax_fixture_index_ms 122.0->223.0; metric:cpp_syntax_fixture_register_index_ms 243.0->284.0
- latency metrics: cargo_fmt_check_ms=1934ms; self_iteration_cargo_fmt_check_ms=323ms; cargo_build_debug_ms=262ms; self_iteration_cargo_check_ms=121ms; temporal_sdk_go_index_ms=785ms; temporal_sdk_go_register_index_ms=846ms; temporal_samples_go_index_ms=141ms; temporal_samples_go_register_index_ms=203ms
