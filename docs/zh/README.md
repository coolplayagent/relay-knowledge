...
- [第 1 章 工程硬约束](03-architecture-specs/01-engineering-hard-constraints.md)
- [第 2 章 GraphRAG 产品与实现路线规格](03-architecture-specs/02-graphrag-product-and-implementation-roadmap.md)
- [第 3 章 基础运行时层规格](03-architecture-specs/03-foundational-runtime.md)
- [第 4 章 Source Scope 与多模态摄取规格](03-architecture-specs/04-source-scope-and-multimodal-ingestion.md)
- [第 5 章 存储层架构设计](03-architecture-specs/05-storage-layer-design.md)
- [第 6 章 开放 Agent Runtime 与混合检索架构](03-architecture-specs/06-open-agent-runtime-and-hybrid-retrieval-architecture.md)
- [第 7 章 代码仓库 Tree-sitter 检索规格](03-architecture-specs/07-code-repository-tree-sitter-retrieval.md)
- [第 8 章 代码仓库检索 v2 优化](03-architecture-specs/08-code-repository-retrieval-v2-optimization.md)
- [第 9 章 代码知识图谱能力参考](03-architecture-specs/09-knowledge-graph-capability-reference.md)
- [第 10 章 Semantic/Vector Provider Backend 规格](03-architecture-specs/10-semantic-vector-provider-backend.md)
- [第 11 章 统一 API 层与交互层架构](03-architecture-specs/11-unified-api-and-interface-architecture.md)
- [第 12 章 常驻进程 Agent 图检索访问规格](03-architecture-specs/12-resident-agent-graph-retrieval-access.md)
- [第 13 章 后台服务、静默更新与自愈设计](03-architecture-specs/13-background-service-and-self-healing.md)
- [第 14 章 先进架构与可观测性设计](03-architecture-specs/14-advanced-architecture-observability.md)
- [第 15 章 安装部署与发布规格](03-architecture-specs/15-installation-and-release.md)
