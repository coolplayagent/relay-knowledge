...
[中文](../../zh/04-research/code-repository-tree-sitter-retrieval-research.md) | [英文](../../en/04-research/code-repository-tree-sitter-retrieval-research.md)
...
- [R12] `relay-knowledge` 本地调研，`docs/zh/03-architecture-specs/knowledge-graph-capability-reference.md`。
