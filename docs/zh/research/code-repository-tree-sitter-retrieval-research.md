...
[中文](../../zh/research/code-repository-tree-sitter-retrieval-research.md) | [英文](../../en/research/code-repository-tree-sitter-retrieval-research.md)
...
- [R12] `relay-knowledge` 本地调研，`docs/specs/knowledge-graph-capability-reference.md`。
