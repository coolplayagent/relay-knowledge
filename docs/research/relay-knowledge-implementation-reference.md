...
| 多模态 | 有 evidence modality/extraction schema、extractor diagnostics、parent grouping、modality read model metadata 和 maintenance worker 输出提交边界 | 真实 OCR/caption/table/layout extractor 产品化仍待接入 | P2 |
...
5. 增加 MCP resources/prompts、持久 audit sink 和 metrics exporters。
