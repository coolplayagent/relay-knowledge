...
- [Chapter 1: Engineering Hard Constraints](03-architecture-specs/01-engineering-hard-constraints.md)
- [Chapter 2: GraphRAG Product and Implementation Roadmap](03-architecture-specs/02-graphrag-product-and-implementation-roadmap.md)
- [Chapter 3: Foundational Runtime](03-architecture-specs/03-foundational-runtime.md)
- [Chapter 4: Source Scope and Multimodal Ingestion](03-architecture-specs/04-source-scope-and-multimodal-ingestion.md)
- [Chapter 5: Storage Layer Design](03-architecture-specs/05-storage-layer-design.md)
- [Chapter 6: Open Agent Runtime and Hybrid Retrieval Architecture](03-architecture-specs/06-open-agent-runtime-and-hybrid-retrieval-architecture.md)
- [Chapter 7: Code Repository Tree-sitter Retrieval Specification](03-architecture-specs/07-code-repository-tree-sitter-retrieval.md)
- [Chapter 8: Code Repository Retrieval v2 Optimization](03-architecture-specs/08-code-repository-retrieval-v2-optimization.md)
- [Chapter 9: Knowledge Graph Capability Reference](03-architecture-specs/09-knowledge-graph-capability-reference.md)
- [Chapter 10: Semantic/Vector Provider Backend Specification](03-architecture-specs/10-semantic-vector-provider-backend.md)
- [Chapter 11: Unified API and Interface Architecture](03-architecture-specs/11-unified-api-and-interface-architecture.md)
- [Chapter 12: Resident Agent Graph Retrieval Access](03-architecture-specs/12-resident-agent-graph-retrieval-access.md)
- [Chapter 13: Background Service, Silent Updates, and Self-Healing](03-architecture-specs/13-background-service-and-self-healing.md)
- [Chapter 14: Advanced Architecture and Observability](03-architecture-specs/14-advanced-architecture-observability.md)
- [Chapter 15: Installation and Release](03-architecture-specs/15-installation-and-release.md)
