...
[English](./03-code-repository-tree-sitter-retrieval.md) | [中文](../../zh/02-capabilities/03-code-repository-tree-sitter-retrieval.md)

This is the English documentation page for `02-capabilities/03-code-repository-tree-sitter-retrieval.md`. It follows the same structure, examples, commands, and implementation contracts as the Chinese edition so readers can switch languages without changing document location.
