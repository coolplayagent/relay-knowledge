...
[English](./code-repository-tree-sitter-retrieval.md) | [中文](../../zh/02-capabilities/code-repository-tree-sitter-retrieval.md)

This is the English documentation page for `code-repository-tree-sitter-retrieval.md`. It follows the same structure, examples, commands, and implementation contracts as the Chinese edition so readers can switch languages without changing document location.
...
[`docs/zh/03-architecture-specs/code-repository-retrieval-v2-optimization.md`](../03-architecture-specs/code-repository-retrieval-v2-optimization.md).
