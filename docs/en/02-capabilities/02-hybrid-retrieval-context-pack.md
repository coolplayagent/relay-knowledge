...
[English](./02-hybrid-retrieval-context-pack.md) | [中文](../../zh/02-capabilities/02-hybrid-retrieval-context-pack.md)

This is the English documentation page for `02-capabilities/02-hybrid-retrieval-context-pack.md`. It follows the same structure, examples, commands, and implementation contracts as the Chinese edition so readers can switch languages without changing document location.
