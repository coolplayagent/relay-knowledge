...
[English](../../en/04-research/code-repository-tree-sitter-retrieval-research.md) | [中文](../../zh/04-research/code-repository-tree-sitter-retrieval-research.md)

This is the English documentation page for `research/code-repository-tree-sitter-retrieval-research.md`. It follows the same structure, examples, commands, and implementation contracts as the Chinese edition so readers can switch languages without changing document location.
...
> 输出用途: 支撑 `docs/zh/03-architecture-specs/code-repository-tree-sitter-retrieval.md` 的设计取舍
...
本仓库已有 `knowledge-graph-capability-reference.md` 调研，关键经验包括:
...
- [R12] `relay-knowledge` local research, `docs/zh/03-architecture-specs/knowledge-graph-capability-reference.md`.
