...
[English](../../en/04-research/06-agent-protocol-graph-retrieval-research.md) | [中文](../../zh/04-research/06-agent-protocol-graph-retrieval-research.md)

This is the English documentation page for `04-research/06-agent-protocol-graph-retrieval-research.md`. It follows the same structure, examples, commands, and implementation contracts as the Chinese edition so readers can switch languages without changing document location.
