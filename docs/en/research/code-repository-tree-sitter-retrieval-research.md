...
[English](../../en/research/code-repository-tree-sitter-retrieval-research.md) | [中文](../../zh/research/code-repository-tree-sitter-retrieval-research.md)
...
> 输出用途: 支撑 `docs/specs/code-repository-tree-sitter-retrieval.md` 的设计取舍
...
- [R12] `relay-knowledge` local research, `docs/specs/knowledge-graph-capability-reference.md`.
