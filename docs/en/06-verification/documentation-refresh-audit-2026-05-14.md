...
[English](./documentation-refresh-audit-2026-05-14.md) | [中文](../../zh/06-verification/documentation-refresh-audit-2026-05-14.md)
...
| Feature docs | Current for GraphRAG context packs, semantic/vector providers, and tree-sitter repository retrieval; audit records now live in the verification volume. |
...
These entries are not missing core loops; they are productization or release
operations tracks that still need end-to-end ownership.

| Capability | Current State | Open Work |
| --- | --- | --- |
