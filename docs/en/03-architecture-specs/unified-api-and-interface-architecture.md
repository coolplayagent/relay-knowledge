...
[English](../../en/03-architecture-specs/unified-api-and-interface-architecture.md) | [中文](../../zh/03-architecture-specs/unified-api-and-interface-architecture.md)

This is the English documentation page for `specs/unified-api-and-interface-architecture.md`. It follows the same structure, examples, commands, and implementation contracts as the Chinese edition so readers can switch languages without changing document location.
