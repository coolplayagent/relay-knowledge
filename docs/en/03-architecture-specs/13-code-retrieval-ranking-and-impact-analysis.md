...
Signals include BM25, identifier-part matches, CamelCase/snake_case segmentation, symbol-kind priors, path proximity, language filters, graph-edge confidence, call direction, import surface/re-export files, chunk quality, freshness, semantic/vector rank, and rerank explanations.
