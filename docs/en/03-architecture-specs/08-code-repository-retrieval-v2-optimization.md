...
[English](../../en/03-architecture-specs/08-code-repository-retrieval-v2-optimization.md) | [中文](../../zh/03-architecture-specs/08-code-repository-retrieval-v2-optimization.md)

This is the English documentation page for `03-architecture-specs/08-code-repository-retrieval-v2-optimization.md`. It follows the same structure, examples, commands, and implementation contracts as the Chinese edition so readers can switch languages without changing document location.
