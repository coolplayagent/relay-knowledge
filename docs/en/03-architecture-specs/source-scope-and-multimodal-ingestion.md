...
[English](../../en/03-architecture-specs/source-scope-and-multimodal-ingestion.md) | [中文](../../zh/03-architecture-specs/source-scope-and-multimodal-ingestion.md)

This is the English documentation page for `specs/source-scope-and-multimodal-ingestion.md`. It follows the same structure, examples, commands, and implementation contracts as the Chinese edition so readers can switch languages without changing document location.
