# Background Service, Silent Updates, and Self-Healing

[English](../../en/03-architecture-specs/13-background-service-and-self-healing.md) | [中文](../../zh/03-architecture-specs/13-background-service-and-self-healing.md)

This is the English documentation page for `03-architecture-specs/13-background-service-and-self-healing.md`. It follows the same structure, examples, commands, and implementation contracts as the Chinese edition so readers can switch languages without changing document location.
