...
[English](../../en/03-architecture-specs/engineering-hard-constraints.md) | [中文](../../zh/03-architecture-specs/engineering-hard-constraints.md)

This is the English documentation page for `specs/engineering-hard-constraints.md`. It follows the same structure, examples, commands, and implementation contracts as the Chinese edition so readers can switch languages without changing document location.
