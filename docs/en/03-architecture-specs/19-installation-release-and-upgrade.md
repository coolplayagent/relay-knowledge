...
- The v1.1.2 release preparation pins `Cargo.toml`, `Cargo.lock`, CLI skill metadata, and the release workflow dry-run default to `1.1.2`; publishing remains tag-driven and starts only after pushing `v1.1.2` or `1.1.2` to GitHub.
