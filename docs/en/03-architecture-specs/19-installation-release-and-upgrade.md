...
- The v1.1.1 release preparation pins `Cargo.toml`, `Cargo.lock`, CLI skill metadata, and the release workflow dry-run default to `1.1.1`; publishing remains tag-driven and starts only after pushing `v1.1.1` or `1.1.1` to GitHub.
