...
- The v1.1.10 release preparation pins `Cargo.toml`, `Cargo.lock`, CLI skill metadata, and the release workflow dry-run default to `1.1.10`; publishing remains tag-driven and starts only after pushing `v1.1.10` or `1.1.10` to GitHub.
