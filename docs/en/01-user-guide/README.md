...
- Code repository graphs with tree-sitter indexing, symbol and relationship retrieval, bounded internal exact-text source fallback, incremental updates, worktree overlays, impact analysis, and reports.
