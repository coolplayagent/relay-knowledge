...
- [Chapter 5: Code Repository Graph](05-code-repository-graph.md): repository registration, code graph indexing, symbol and relationship queries, incremental updates, impact analysis, and reports.
