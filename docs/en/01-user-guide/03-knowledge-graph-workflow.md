# Chapter 3: Knowledge Graph Workflow

[English](../../en/01-user-guide/03-knowledge-graph-workflow.md) | [中文](../../zh/01-user-guide/03-knowledge-graph-workflow.md)

This is the English documentation page for `user-guide/03-knowledge-graph-workflow.md`. It follows the same structure, examples, commands, and implementation contracts as the Chinese edition so readers can switch languages without changing document location.
