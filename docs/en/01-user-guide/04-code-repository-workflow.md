# Chapter 4: Code Repository Workflow

[English](../../en/01-user-guide/04-code-repository-workflow.md) | [中文](../../zh/01-user-guide/04-code-repository-workflow.md)

This is the English documentation page for `user-guide/04-code-repository-workflow.md`. It follows the same structure, examples, commands, and implementation contracts as the Chinese edition so readers can switch languages without changing document location.
