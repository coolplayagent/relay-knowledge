# Chapter 6: Agents and Resident Service

[English](../../en/01-user-guide/06-agent-and-service.md) | [中文](../../zh/01-user-guide/06-agent-and-service.md)

This is the English documentation page for `user-guide/06-agent-and-service.md`. It follows the same structure, examples, commands, and implementation contracts as the Chinese edition so readers can switch languages without changing document location.
