...
[English](../../en/05-benchmarks/relay-teams-optimization-study-2026-05-14.md) | [中文](../../zh/05-benchmarks/relay-teams-optimization-study-2026-05-14.md)

This is the English documentation page for `benchmarks/relay-teams-optimization-study-2026-05-14.md`. It follows the same structure, examples, commands, and implementation contracts as the Chinese edition so readers can switch languages without changing document location.
...
Baseline: [relay-teams CLI and Web Benchmark Baseline](relay-teams-baseline-2026-05-14.md)
