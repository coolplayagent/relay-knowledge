...
#[path = "architecture_boundaries/layout_application_and_domain.rs"]
mod layout_application_and_domain;
#[path = "architecture_boundaries/layout_storage_and_interfaces.rs"]
mod layout_storage_and_interfaces;
