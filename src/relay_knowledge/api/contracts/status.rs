...
pub struct RuntimeStatus {
    ...
    pub qos_current_connections: usize,
    pub qos_current_in_flight_requests: usize,
    pub qos_current_queued_requests: usize,
    pub qos_admitted_total: u64,
    pub qos_queued_total: u64,
    pub qos_rejected_total: u64,
    pub qos_timed_out_total: u64,
    pub qos_cancelled_total: u64,
    pub qos_dropped_total: u64,
