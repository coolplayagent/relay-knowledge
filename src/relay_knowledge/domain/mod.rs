...
pub use code::{
    ...
    CodeSymbolKind, CodeSymbolRecord, CodeWorkspaceDetectionConfig, CodeWorkspaceMember,
    ...
    SymbolRole, clean_git_commit_from_snapshot_identity, code_snapshot_expected_scope_id,
    code_snapshot_scope_id, code_snapshot_scope_is_fact_versioned, project_okf_neighborhood,
};
pub use core::{
