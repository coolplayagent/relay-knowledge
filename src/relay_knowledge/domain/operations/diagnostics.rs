//! Technology-neutral health and graph inspection projections.

use serde::{Deserialize, Serialize};

use crate::domain::{
    CodeParseStatusCounts, CodeRepositoryTotals, FileIndexDiagnostics, GraphVersion, IndexCursor,
    IndexRefreshDiagnostics, IndexStatus,
};
