//! Applies effective scope filters and bounded worktree-change admission.
...
use crate::code::{
    CodeIndexError,
    source::{changes, layout as scope},
};

use super::{super::MAX_INCREMENTAL_GITLINK_EXPANDED_PATHS, untracked};
