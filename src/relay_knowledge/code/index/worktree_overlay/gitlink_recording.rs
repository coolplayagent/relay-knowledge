...
use super::{
    super::{MAX_INCREMENTAL_GITLINK_EXPANDED_PATHS, ids::stable_content_hash},
...
pub(super) struct WorktreeOverlayRecorder<'a, 'scope> {
    pub(super) scope: &'a WorktreeOverlayScope<'scope>,
...
#[cfg(test)]
#[path = "gitlink_recording_tests.rs"]
mod tests;
