#[derive(Default)]
pub(in crate::code::config_files) struct BlockScalarTracker {
    parent_indent: Option<usize>,
}

impl BlockScalarTracker {
    pub(in crate::code::config_files) fn should_skip(&mut self, line: &str, trimmed: &str) -> bool {
        if trimmed.is_empty() {
...
pub(in crate::code::config_files) fn mapping_key(trimmed: &str) -> Option<&str> {
