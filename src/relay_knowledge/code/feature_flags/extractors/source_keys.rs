use super::{
    lexical::{find_pattern_with_quotes, push_unique, valid_source_key},
...
pub(in crate::code::feature_flags) fn env_keys(line: &str) -> Vec<String> {
...
pub(in crate::code::feature_flags) fn preprocessor_flag_keys(
    line: &str,
    language_id: &str,
) -> Vec<String> {
...
fn find_code_pattern(line: &str, pattern: &str, start: usize) -> Option<usize> {
    find_pattern_with_quotes(line, pattern, start, is_string_quote_character)
}
...
pub(in crate::code::feature_flags) fn usage_edge_kind(line: &str) -> &'static str {
