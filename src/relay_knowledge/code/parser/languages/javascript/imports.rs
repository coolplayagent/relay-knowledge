...
use crate::code::parser::{
    imports::quoted_specifier,
    nodes::{SyntaxRange, compact_whitespace, node_text, syntax_range},
};

pub(in crate::code::parser) fn dynamic_import(
    language_id: &str,
    content: &str,
    node: Node<'_>,
...
pub(in crate::code::parser) fn re_export(
    language_id: &str,
    content: &str,
    node: Node<'_>,
) -> Option<(String, SyntaxRange)> {
