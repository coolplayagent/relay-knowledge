...
use diff::{SubmoduleDiffRequest, bounded_submodule_parent_paths, changed_submodule_path_sets};
...
pub(in crate::code) use paths::{
    GitlinkPathExpansion, SubmodulePathEntry, ensure_gitlink_expansion_budget,
