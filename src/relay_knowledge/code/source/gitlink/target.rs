...
use super::{
    ...
    paths::{GitlinkTarget, GitlinkTargetLocation},
};

pub(in crate::code) fn submodule_bytes(
    root: &Path,
    commit: &str,
    path: &str,
...
pub(in crate::code) fn submodule_blob_size(
    root: &Path,
    commit: &str,
    path: &str,
...
pub(in crate::code) fn git_blob_bytes_with_submodules(
    root: &Path,
    commit: &str,
    path: &str,
) -> Result<Vec<u8>, CodeIndexError> {
...
pub(in crate::code) fn git_dir_blob_bytes_with_submodules(
    git_dir: &Path,
    commit: &str,
    path: &str,
) -> Result<Vec<u8>, CodeIndexError> {
