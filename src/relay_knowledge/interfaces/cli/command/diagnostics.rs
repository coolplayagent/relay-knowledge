    ...
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::InvalidSoftwareKind(value) => write!(
                formatter,
                "invalid --kind value '{value}', expected dependencies, sdks, files, topics, relationships, build, modules, iac, design, systems, apis, resources, tests, deployments, releases, statements, conflicts, or all"
            ),
