...
use crate::{
    ...
    net::qos::{QosPermit, QosPolicy, QosRuntime},
};

pub use outbound::{
    HttpClientError, OutboundClientError, outbound_json_client, outbound_json_client_with_policy,
    post_json, post_json_with_qos,
};
