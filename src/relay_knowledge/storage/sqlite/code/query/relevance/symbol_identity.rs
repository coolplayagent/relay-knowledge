...
pub(in crate::storage::sqlite::code::query) struct SymbolIdentityQuery {
    leaf_name: String,
    scoped_terms: Option<Vec<String>>,
}

impl SymbolIdentityQuery {
    pub(in crate::storage::sqlite::code::query) fn from_query(query: &str) -> Option<Self> {
    ...
    pub(in crate::storage::sqlite::code::query) fn leaf_name(&self) -> &str {
        &self.leaf_name
    }

    pub(in crate::storage::sqlite::code::query) fn is_scoped(&self) -> bool {
        self.scoped_terms.is_some()
    }

    pub(in crate::storage::sqlite::code::query) fn scoped_like_pattern(&self) -> Option<String> {
    ...
    pub(in crate::storage::sqlite::code::query) fn matches_symbol(
        &self,
        name: &str,
        qualified_name: &str,
        signature: &str,
...
pub(in crate::storage::sqlite::code::query) fn query_is_single_symbol_identity(
    query: &str,
) -> bool {
...
pub(in crate::storage::sqlite::code::query) fn scoped_query_terms(
    query: &str,
) -> Option<Vec<String>> {
...
pub(in crate::storage::sqlite::code::query) fn contains_scoped_terms(
    field: &str,
    query_terms: &[String],
) -> bool {
