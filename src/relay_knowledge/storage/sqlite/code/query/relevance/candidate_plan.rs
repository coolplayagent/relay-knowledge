...
use super::super::hits::chunk_layers;
use super::{
    filters::{
...
#[cfg(test)]
pub(in crate::storage::sqlite::code::query) fn candidate_condition(
    fields: &[&str],
    query: &str,
) -> (String, Vec<Value>) {
...
pub(in crate::storage::sqlite::code::query) fn candidate_patterns(
    query: &str,
    max_patterns: usize,
) -> Vec<String> {
...
pub(in crate::storage::sqlite::code::query) fn fts_query_terms(query: &str) -> Vec<String> {
    query
...
#[derive(Clone, Copy)]
pub(in crate::storage::sqlite::code::query) enum CandidateLayer {
    Symbol,
    Reference,
    Call,
    Import,
...
pub(in crate::storage::sqlite::code::query) fn candidate_limit(
...
pub(in crate::storage::sqlite::code::query) fn chunk_layers_for_request(
    request: &CodeRetrievalRequest,
    parse_status: &str,
...
pub(in crate::storage::sqlite::code::query) fn fts_values_for_limited_with_language(
    source_scope: &str,
