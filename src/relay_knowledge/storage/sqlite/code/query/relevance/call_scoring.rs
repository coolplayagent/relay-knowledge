...
pub(in crate::storage::sqlite::code::query) fn repeated_call_site_bonus(
    base_score: f64,
...
pub(in crate::storage::sqlite::code::query) fn callee_related_name_bonus(
    query: &str,
    callee_name: &str,
    request: &CodeRetrievalRequest,
) -> f64 {
...
pub(in crate::storage::sqlite::code::query) fn directional_call_context_bonus(
    query: &ScoreQuery,
    base_score: f64,
...
pub(in crate::storage::sqlite::code::query) fn same_named_caller_penalty(
    caller_name: Option<&str>,
    callee_name: &str,
    request: &CodeRetrievalRequest,
) -> f64 {
