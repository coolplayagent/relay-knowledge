...
pub(in crate::storage::sqlite::code::query) fn fts_path_and_language_filter_sql(
...
pub(in crate::storage::sqlite::code::query) fn path_filter_sql_for_column(
    column: &str,
    status: &CodeRepositoryStatus,
    request: &CodeRetrievalRequest,
) -> String {
...
pub(in crate::storage::sqlite::code::query) fn language_filter_sql_for_column(
    column: &str,
    status: &CodeRepositoryStatus,
    request: &CodeRetrievalRequest,
) -> String {
...
pub(in crate::storage::sqlite::code::query) fn language_filter_sql_for_columns(
    language_column: &str,
    path_column: &str,
    status: &CodeRepositoryStatus,
    request: &CodeRetrievalRequest,
...
pub(in crate::storage::sqlite::code::query) fn kind_filter_sql_for_column(
    column: &str,
    request: &CodeRetrievalRequest,
) -> String {
...
pub(in crate::storage::sqlite::code::query) fn push_query_path_substring_filter_sql(
...
pub(in crate::storage::sqlite::code::query) fn push_path_filter_values(
...
pub(in crate::storage::sqlite::code::query) fn push_query_path_substring_filter_values(
    values: &mut Vec<Value>,
    filters: &[String],
) {
    values.extend(
...
pub(in crate::storage::sqlite::code::query) fn push_language_filter_values(
    values: &mut Vec<Value>,
    filters: &[String],
) {
...
pub(in crate::storage::sqlite::code::query) fn push_kind_filter_values(
    values: &mut Vec<Value>,
    request: &CodeRetrievalRequest,
) {
