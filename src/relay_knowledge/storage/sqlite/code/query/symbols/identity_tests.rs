...
use crate::storage::sqlite::code::query::api_identities::hybrid_api_symbol_identities;
...
#[test]
fn api_dense_hybrid_query_keeps_broad_symbol_fts_for_incomplete_identity_lookup() {
    let request = make_request(
        "worker.New RegisterWorkflow RegisterActivity InterruptCh task queue",
        CodeQueryKind::Hybrid,
    );
