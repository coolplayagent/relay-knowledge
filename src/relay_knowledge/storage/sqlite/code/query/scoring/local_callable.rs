...
use super::super::excerpts::line_declares_local_callable;

pub(in super::super) const LOCAL_CALLABLE_DECLARATION_BONUS: f64 = 1.8;

pub(in super::super) fn local_callable_declaration_bonus(
    base_score: f64,
