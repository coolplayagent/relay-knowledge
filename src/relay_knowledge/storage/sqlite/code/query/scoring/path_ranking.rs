...
#[derive(Clone, Copy)]
pub(in super::super) struct CallSiteQueryIntent {
    pub(in super::super) test_or_benchmark: bool,
    pub(in super::super) example_or_sample: bool,
}

const CALLER_RESULT_ASSIGNMENT_BONUS: f64 = 1.15;
const CALLER_RESULT_NAMED_SLOT_BONUS: f64 = 0.25;

pub(in super::super) fn call_site_source_path_bonus(
    base_score: f64,
    path: &str,
...
pub(in super::super) fn call_site_test_path_penalty(
    base_score: f64,
    path: &str,
    request: &CodeRetrievalRequest,
    query_has_test_intent: bool,
...
pub(in super::super) fn call_site_example_path_penalty(
    base_score: f64,
    path: &str,
    request: &CodeRetrievalRequest,
...
pub(in super::super) fn reference_source_path_bonus(
    base_score: f64,
    path: &str,
    request: &CodeRetrievalRequest,
    query_has_test_intent: bool,
...
pub(in super::super) fn reference_test_path_penalty(
    base_score: f64,
    path: &str,
    request: &CodeRetrievalRequest,
    query_has_test_intent: bool,
...
pub(in super::super) fn caller_result_assignment_bonus(
    base_score: f64,
    path: &str,
    query: &str,
...
pub(in super::super) fn callee_member_context_bonus(
    base_score: f64,
    caller_excerpt: Option<&str>,
    callee_name: &str,
    request: &CodeRetrievalRequest,
...
pub(in super::super) fn declaration_surface_path_bonus(
...
pub(in super::super) fn symbol_declaration_surface_path_bonus(
    base_score: f64,
    kind: &str,
    path: &str,
    request: &CodeRetrievalRequest,
...
pub(in super::super) fn symbol_implementation_path_bonus(
    base_score: f64,
    signature: &str,
    path: &str,
    request: &CodeRetrievalRequest,
...
pub(in super::super) fn import_test_path_penalty(
    base_score: f64,
    path: &str,
    request: &CodeRetrievalRequest,
    query_has_test_intent: bool,
...
pub(in super::super) fn symbol_test_path_penalty(
    base_score: f64,
    path: &str,
    request: &CodeRetrievalRequest,
    query_has_test_intent: bool,
...
pub(in super::super) fn query_mentions_test_or_benchmark(query: &str) -> bool {
    query
...
pub(in super::super) fn path_looks_like_test_or_benchmark(path: &str) -> bool {
