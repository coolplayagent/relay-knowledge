...
use super::lifecycle::lifecycle_finalization_bonus;
...
pub(in super::super) fn execution_flow_chunk_bonus(
    base_score: f64,
    query: &str,
    content: &str,
    path: &str,
...
pub(in super::super) fn inline_construct_chunk_bonus(
    base_score: f64,
    query: &str,
    content: &str,
    path: &str,
...
pub(in super::super) fn compact_high_coverage_chunk_bonus(
    base_score: f64,
    query: &str,
    content: &str,
    path: &str,
...
pub(in super::super) fn compact_api_sequence_chunk_bonus(
    base_score: f64,
    query: &str,
    content: &str,
    path: &str,
...
pub(in super::super) fn source_definition_body_chunk_bonus(
    base_score: f64,
    query: &str,
    content: &str,
    path: &str,
