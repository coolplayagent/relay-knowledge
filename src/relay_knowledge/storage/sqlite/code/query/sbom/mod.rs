//! Dependency inventory retrieval and SBOM hit projection.
...
use super::{
    HitParts, filter_dedupe_sort_truncate, fts_path_and_language_filter_sql, hit_from_parts,
    prepare_code_search_statement, required_scope, rows::DependencyRow,
};
