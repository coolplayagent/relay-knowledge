//! Retrieval-hit construction, filtering, deduplication, and degradation metadata.
...
use super::super::{
    ...
    lifecycle::status::{repository_scope_status, repository_status},
};

pub(in crate::storage::sqlite::code) fn required_repository(
...
pub(in crate::storage::sqlite::code) fn selected_row(
    path: &str,
    language_id: &str,
    is_generated: bool,
...
pub(in crate::storage::sqlite::code) fn chunk_layers(
    parse_status: &str,
...
pub(in crate::storage::sqlite::code) struct HitParts {
    pub(in crate::storage::sqlite::code) path: String,
    pub(in crate::storage::sqlite::code) language_id: String,
    pub(in crate::storage::sqlite::code) byte_range: RepositoryCodeRange,
    pub(in crate::storage::sqlite::code) line_range: RepositoryCodeRange,
    pub(in crate::storage::sqlite::code) symbol_snapshot_id: Option<String>,
    pub(in crate::storage::sqlite::code) canonical_symbol_id: Option<String>,
    pub(in crate::storage::sqlite::code) file_id: Option<String>,
    pub(in crate::storage::sqlite::code) retrieval_layers: Vec<CodeRetrievalLayer>,
    pub(in crate::storage::sqlite::code) score: f64,
    pub(in crate::storage::sqlite::code) excerpt: String,
    pub(in crate::storage::sqlite::code) is_generated: bool,
    pub(in crate::storage::sqlite::code) degraded_reason: Option<String>,
    pub(in crate::storage::sqlite::code) edge_kind: Option<String>,
    pub(in crate::storage::sqlite::code) edge_resolution_state: Option<String>,
    pub(in crate::storage::sqlite::code) edge_target_hint: Option<String>,
    pub(in crate::storage::sqlite::code) edge_confidence_basis_points: Option<u16>,
    pub(in crate::storage::sqlite::code) edge_confidence_tier: Option<String>,
}

pub(in crate::storage::sqlite::code) fn hit_from_parts(
    status: &CodeRepositoryStatus,
    parts: HitParts,
) -> CodeRetrievalHit {
    CodeRetrievalHit {
...
pub(in crate::storage::sqlite::code) fn required_scope(
    status: &CodeRepositoryStatus,
...
pub(in crate::storage::sqlite::code) fn dedupe_sort_truncate(
...
pub(in crate::storage::sqlite::code) fn filter_dedupe_sort_truncate(
    hits: &mut Vec<CodeRetrievalHit>,
    request: &CodeRetrievalRequest,
) {
...
pub(in crate::storage::sqlite::code) fn filtered_hits_for_gate(
...
pub(in crate::storage::sqlite::code) fn query_field_filtered_hits_for_gate(
    hits: &[CodeRetrievalHit],
    request: &CodeRetrievalRequest,
) -> Vec<CodeRetrievalHit> {
    let mut filtered = hits.to_vec();
...
pub(in crate::storage::sqlite::code) fn has_query_field_hit_filters(
    request: &CodeRetrievalRequest,
) -> bool {
...
pub(in crate::storage::sqlite::code) fn mark_hits_degraded(
    hits: &mut [CodeRetrievalHit],
    reason: &str,
) {
    for hit in hits {
