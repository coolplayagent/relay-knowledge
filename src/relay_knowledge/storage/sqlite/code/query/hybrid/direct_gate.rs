...
use super::super::api_identities::{ApiSymbolIdentity, hybrid_api_symbol_identities};
use super::planning::{
    hybrid_query_has_conversion_expansion_intent, hybrid_query_has_declaration_expansion_intent,
    hybrid_query_has_inline_expansion_intent, hybrid_sequence_terms,
};

pub(in super::super) fn hybrid_direct_results_can_answer_without_graph_expansion(
