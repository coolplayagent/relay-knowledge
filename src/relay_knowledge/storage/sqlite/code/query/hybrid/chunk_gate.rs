...
use super::{
    direct_gate::hybrid_direct_results_can_answer_without_graph_expansion,
    planning::{
...
pub(in super::super) fn hybrid_chunk_results_can_answer_without_graph_expansion(
...
pub(in super::super) fn hybrid_hits_can_answer_without_graph_expansion(
    request: &CodeRetrievalRequest,
    hits: &[CodeRetrievalHit],
) -> bool {
...
pub(in super::super) fn retain_query_language_scoped_workflow_hits(
    request: &CodeRetrievalRequest,
