...
use crate::{
    ...
    storage::{
        FileContentEntry, FileContentSearchHit, FileContentSearchRequest, FileIndexRoot,
        FileKnowledgeFactCandidate, StorageError,
    },
};
...
fn fact_candidates_for_chunk(
    ...
    content_line_spans(content, span)
        ...
        .filter_map(|(line, line_span)| {
            fact_candidate_for_line(source_scope, source_path, chunk_id, line)
