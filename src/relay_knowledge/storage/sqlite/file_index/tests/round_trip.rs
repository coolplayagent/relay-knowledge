//! Cross-owner file-index replacement, search, and diagnostics contracts.

use std::{collections::BTreeSet, time::Instant};

use rusqlite::Connection;

use super::super::root_update::INDEXED_STATUS;
use super::super::{diagnostics, initialize_schema, mark_unconfigured_roots, replace_root, search};
use crate::storage::{FileIndexEntry, FileIndexRoot, FileIndexRootUpdate, FileSearchRequest};
...
#[test]
fn search_rejects_queries_without_searchable_terms() {
