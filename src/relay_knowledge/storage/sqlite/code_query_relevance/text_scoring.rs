...
pub(in crate::storage::sqlite::code::code_query) struct ScoreQuery {
    tokens: Vec<String>,
}
...
impl ScoreQuery {
    pub(in crate::storage::sqlite::code::code_query) fn new(query: &str) -> Self {
        let tokens = score_query_tokens(query);

        Self { tokens }
    }

    pub(in crate::storage::sqlite::code::code_query) fn score<'field>(
        &self,
...
pub(in crate::storage::sqlite::code::code_query) fn score_text<'field>(
    query: &str,
    fields: impl IntoIterator<Item = &'field str>,
) -> f64 {
...
pub(in crate::storage::sqlite::code::code_query) fn score_exact_path(
    query: &str,
    path: &str,
) -> f64 {
