...
use crate::{
    domain::{
        CodeIndexCheckpoint, CodeIndexTaskQueueStatus, CodeIndexTaskRecord, CodeIndexTaskState,
...
use super::code_cleanup::delete_scope_index;
use super::code_tasks_worktree::active_worktree_base_scopes;
use record_mapping::{
    checkpoint_from_row, task_from_row, task_select_sql, task_update_returning_sql,
};
