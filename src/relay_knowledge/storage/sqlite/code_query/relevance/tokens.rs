...
pub(in crate::storage::sqlite::code::code_query) fn identity_terms(token: &str) -> Vec<String> {
    token
...
pub(in crate::storage::sqlite::code::code_query) fn simple_identity_token(token: &str) -> bool {
    !token.is_empty()
        && token
            .chars()
...
pub(in crate::storage::sqlite::code::code_query) fn score_query_tokens(query: &str) -> Vec<String> {
...
pub(in crate::storage::sqlite::code::code_query) fn token_has_path_like_extension(
    token: &str,
) -> bool {
...
pub(in crate::storage::sqlite::code::code_query) fn identifier_field_matches_token(
    field: &str,
    token: &str,
) -> bool {
...
pub(in crate::storage::sqlite::code::code_query) fn query_terms(query: &str) -> Vec<String> {
    query
        .split(|character: char| !(character.is_ascii_alphanumeric() || character == '_'))
        .filter(|term| !term.is_empty())
        .map(str::to_owned)
...
pub(in crate::storage::sqlite::code::code_query) fn identifier_search_tokens(
    value: &str,
) -> Vec<String> {
...
pub(in crate::storage::sqlite::code::code_query) fn identifier_match_terms(
    value: &str,
) -> Vec<String> {
    let mut tokens = Vec::new();
...
pub(in crate::storage::sqlite::code::code_query) fn identifier_tokens(
    value: &str,
...
pub(in crate::storage::sqlite::code::code_query) fn escape_sql_like(value: &str) -> String {
