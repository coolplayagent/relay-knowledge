//! Cross-owner Maven effective-model follow-up regressions.

use super::super::{build_facts, model::PomDocument, model::resolve_effective_model_load};
...
fn model_at<'a>(
    models: &'a [super::super::model::EffectivePom],
    path: &str,
) -> &'a super::super::model::EffectivePom {
    models
        .iter()
