...
pub(in crate::application) fn runtime_status(runtime: &RuntimeConfiguration) -> RuntimeStatus {
...
pub(in crate::application) fn runtime_status_with_model_profiles(
...
pub(in crate::application) fn agent_protocol_status(
    runtime: &RuntimeConfiguration,
) -> AgentProtocolStatus {
    let network = runtime.network.current();
