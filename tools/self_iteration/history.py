            ...
            writer.writerow(
                {
                    ...
                    "foundational_capability": run.get("foundational_capability", ""),
                    "competitive_capability": run.get("competitive_capability", ""),
                    "accuracy": run.get("accuracy", 0.0),
                    "semantic_vector": run.get("semantic_vector", ""),
                    "research_judge": run.get("research_judge", ""),
