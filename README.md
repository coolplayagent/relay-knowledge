...
and `code_index_health_isolation_cases`, plus a registration-language
guardrail, so expired code-index leases, stale worker completions,
dead-letter recovery, checkpoint lease renewal, service health liveness,
