...
same-repository task serialization, service health liveness,
concurrent committed-scope code queries, and mixed-language registration
safety cannot regress without running exhaustive large-repository workloads.
